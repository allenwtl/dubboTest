package com.allen.learn.service.processor;
...
public class ClientMainProcessor {
    ...
    public static void main(String[] args) throws Exception {
        ApplicationContext app =
                new ClassPathXmlApplicationContext(new String[]{"config/dubbo-client-config.xml"});

        // 开始RPC调用
        MyService myService = (MyService)app.getBean("myService");
        LOGGER.info("myService = " + myService.doTest("1234", "abcde"));
